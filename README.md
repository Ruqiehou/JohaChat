...
> 🤖 基于 ncatbot + LLM 的智能群聊机器人框架，支持多模型切换、智能回复决策、风格学习、知识库检索。
...
| **人设管理** | 可配置多个人设（Persona），自动监控人设稳定性 |
...
- **Python**: >= 3.9
- **NapCatQQ**: 运行中（QQ 机器人协议端）
  - 下载地址: [NapCatQQ GitHub](https://github.com/NapNeko/NapCatQQ)
...
# 3. 配置 NapCatQQ
#    确保 NapCatQQ 已启动，WebSocket 端口为 3002（或修改 config.yaml）
...
| 依赖 | 版本 | 用途 |
|------|------|------|
| `ncatbot` | **4.4.1** | QQ 机器人框架核心（⚠️ 必须使用此版本） |
...
```yaml
root: '2654278608'          # 超级管理员 QQ
bt_uin: '3831279795'         # 机器人 QQ 号
napcat:
...
人设监控器会持续检查机器人的回复是否偏离配置的人设。当检测到偏离时，会向管理员报告人设稳定性问题。
