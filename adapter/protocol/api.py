"""
协议层 API 接口
BotAPI: 对 NapCatClient.call_api() 做 OneBot 协议层的高层封装
"""
...
class BotAPI:
    """机器人 API 封装类 —— OneBot 协议层的高层封装

    对 NapCatClient.call_api() 做语义化封装，
    调用方无需了解底层传输细节。
    """
    ...
    async def send_group_message(
        ...
        return await self.client.call_api("send_group_msg", {
            "group_id": group_id,
            "message": segments,
        })
    ...
    async def send_private_message(
        ...
        return await self.client.call_api("send_private_msg", {
            "user_id": user_id,
            "message": segments,
        })
    ...
    async def delete_message(self, message_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("delete_msg", {"message_id": message_id})
    ...
    async def get_message(self, message_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_msg", {"message_id": message_id})
    ...
    async def group_poke(self, group_id: int, user_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("group_poke", {
            "group_id": group_id,
            "user_id": user_id,
        })
    ...
    async def friend_poke(self, user_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("friend_poke", {"user_id": user_id})
    ...
    async def get_group_message_history(
        ...
        return await self.client.call_api("get_group_msg_history", params)
    ...
    async def get_private_message_history(
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_friend_msg_history", {
            "user_id": user_id,
    ...
    async def get_group_list(self) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_group_list")
    ...
    async def get_group_member_list(self, group_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_group_member_list", {"group_id": group_id})
    ...
    async def get_group_member_info(self, group_id: int, user_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_group_member_info", {
            "group_id": group_id,
            "user_id": user_id,
        })
    ...
    async def set_group_ban(self, group_id: int, user_id: int, duration: int = 1800) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("set_group_ban", {
            "group_id": group_id,
            "user_id": user_id,
            "duration": duration,
        })
    ...
    async def set_group_kick(self, group_id: int, user_id: int, reject_add_request: bool = False) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("set_group_kick", {
            "group_id": group_id,
            "user_id": user_id,
    ...
    async def set_group_card(self, group_id: int, user_id: int, card: str = "") -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("set_group_card", {
            "group_id": group_id,
            "user_id": user_id,
            "card": card,
        })
    ...
    async def get_friend_list(self) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_friend_list")
    ...
    async def get_login_info(self) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_login_info")
    ...
    async def get_stranger_info(self, user_id: int) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_stranger_info", {"user_id": user_id})
    ...
    async def set_friend_add_request(self, flag: str, approve: bool = True, remark: str = "") -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("set_friend_add_request", {
            "flag": flag,
            "approve": approve,
            "remark": remark,
        })
    ...
    async def set_group_add_request(self, flag: str, sub_type: str, approve: bool = True, reason: str = "") -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("set_group_add_request", {
            "flag": flag,
            "sub_type": sub_type,
            "approve": approve,
            "reason": reason,
    ...
    async def send_like(self, user_id: int, times: int = 1) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("send_like", {
            "user_id": user_id,
            "times": times,
        })
    ...
    async def get_version_info(self) -> APIResponse:
        ...
        Returns:
            APIResponse
        """
        return await self.client.call_api("get_version_info")
