...
# 全局实例
_kb_search_tool_instance = None


def get_kb_search_tool():
    """获取知识库搜索工具实例（单例）"""
    global _kb_search_tool_instance
    if _kb_search_tool_instance is None:
        _kb_search_tool_instance = KnowledgeBaseSearchTool()
    return _kb_search_tool_instance
